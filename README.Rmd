...
To obtain a colour palette as a vector, use `mojchart_palette()`, again specifying the number of colours and the colour scheme. The `display_palette()` function displays the colours.
...
The `display_scheme()` function shows all the colour palettes within a colour scheme, as shown for all of the colour schemes [here](man/additional-documentation/schemes.md).
