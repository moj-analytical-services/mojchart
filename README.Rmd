...
To obtain a palette as a vector, use `mojchart_palette()`, again specifying the number of colours and the colour scheme. The `swatch()` function displays a preview.
